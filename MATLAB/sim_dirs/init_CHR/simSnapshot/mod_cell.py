            ...
            for vInd in range(Nvol[trode]):
                ...
                for pInd in range(Npart[trode]):
                    ...
                    try:
                        ...
                        RHS += -(ndD["beta"][trode] * (1-ndD["poros"][trode]) * ndD["P_L"][trode] * Vj * (self.particles[trode][vInd,pInd].dcbardt() + self.particles[trode][vInd,pInd].dcsidedt()))
...
#                eta = 0.
            ...
            for vInd in range(Nlyte):
                ...
                # Charge Conservation
                eq = self.CreateEquation("lyte_cconservationharge_cons_vol{vInd}".format(vInd=vInd))
