...
class muRfuncs():
    ...
    """
    def __init__(self, T, ndD, Ar, **kwargs):
        ...
        materialData['LiMn2O4'] = self.LiMn2O4
    ...
    def LiMn2O4_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """ Doyle, Newman, 1996 """
        # OCV in V vs Li/Li+
    ...
    def LiMn2O4_ss2(self, y, ybar, muR_ref, Ar, ISfuncs=None):
    ...
    def LiC6_coke_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """ Doyle, Newman, 1996 """
    ...
    def LiC6_coke_ss2(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """ Fuller, Doyle, Newman, 1994 """
        c1 = -0.132056
        c2 = 1.40854
        c3 = -3.52312
    ...
    def LiC6_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
    ...
    def LiC6_ss2(self, y, ybar, muR_ref, Ar, ISfuncs=None):
    ...
    def LiC6_2step_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """
    ...
    def Li_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        muR = 0.*y + muR_ref
        actR = 0.*y + 1.
        return muR, actR

    def NCA_ss1(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """
    ...
    def NCA_ss2(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """
    ...
    def testIS_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
    ...
    def testRS_ss(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        """
    ...
    def graphite_2param_homog(self, y, Omga, Omgb, Omgc, EvdW, Ar, ISfuncs=(None, None)):
        """ Helper function """
        y1, y2 = y
    ...
    def graphite_1param_homog(self, y, Omga, Omgb, Ar, ISfuncs=None):
        """ Helper function """
        width = 5e-2
        tailScl = 5e-2
    ...
    def graphite_1param_homog_2(self, y, Omga, Omgb, Ar, ISfuncs=None):
        """ Helper function """
        width = 5e-2
        tailScl = 5e-2
        slpScl = 0.45
    ...
    def graphite_1param_homog_3(self, y, Omga, Omgb, Ar, ISfuncs=None):
    ...
    def non_homog_rect_fixed_csurf(self, y, ybar, B, kappa, ywet, Ar):
        """ Helper function """
        N = len(y)
    ...
    def non_homog_round_wetting(self, y, ybar, B, kappa, beta_s, shape, r_vec, Ar):
        """ Helper function """
        dr = r_vec[1] - r_vec[0]
        Rs = 1.
    ...
    def general_non_homog(self, y, ybar, Ar):
        """ Helper function """
        ptype = self.ndD["type"]
            ...
            if shape == "C3":
                ...
                if mod1var:
                    muR_nh = self.non_homog_round_wetting(
                        y, ybar, B, kappa, beta_s, shape, r_vec, Ar)
                elif mod2var:
                    muR1_nh = self.non_homog_round_wetting(
                        y[0], ybar[0], B, kappa, beta_s, shape, r_vec, Ar)
                    muR2_nh = self.non_homog_round_wetting(
                        y[1], ybar[1], B, kappa, beta_s, shape, r_vec, Ar)
    ...
    def LiC6(self, y, ybar, muR_ref, Ar, ISfuncs=(None, None)):
        """ Ferguson and Bazant 2014 """
        muRtheta = -self.eokT*0.08847
        #muRtheta = -self.eokT*3.422
        ndD = self.ndD
        muR1homog, muR2homog = self.graphite_2param_homog(y, ndD["Omga"], ndD["Omgb"], ndD["Omgc"], ndD["EvdW"], ISfuncs)
        muR1nonHomog, muR2nonHomog = self.general_non_homog(y, ybar, Ar)
    ...
    def LiC6_1param(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        muRtheta = -self.eokT*0.1
        ndD = self.ndD
    ...
    def testRS(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        muRtheta = 0.
    ...
    def testRS_ps(self, y, ybar, muR_ref, Ar, ISfuncs=None):
        muRtheta = -self.eokT*0.1
        muRhomog = self.reg_sln(y, self.ndD["Omga"], ISfuncs)
        muRnonHomog = self.general_non_homog(y, ybar, Ar)
        muR = muRhomog + muRnonHomog
